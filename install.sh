...
echo 'alias leboa="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/Dogechi/LeBoA.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/Dogechi/LeBoA.git'"
...
rm -rf "$HOME/.config/@leboa"
rm -rf "$HOME/.config/@leboa"
rm -rf "$HOME/.config/leboa-core"
